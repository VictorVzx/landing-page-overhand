...
discord.addEventListener("click", function () {
  discord.innerHTML =
    '<img src="assets/img/discord.png" alt="discordimg" width="20px"> Carregando...';
  ...
  setTimeout(() => {
    discord.innerHTML =
      '<img src="assets/img/discord.png" alt="discordimg" width="20px"> Discord';
...
github.addEventListener("click", function () {
  github.innerHTML =
    '<img src="./assets/img/github.png" alt="github" width="20px"> Carregando...';
  github.style.cursor = "not-allowed";
  discord.style.cursor = "not-allowed";
  github.disabled = true;
  discord.disabled = true;
  ...
  setTimeout(() => {
    github.innerHTML =
      '<img src="./assets/img/github.png" alt="github" width="20px"> Github';
    github.style.cursor = "pointer";
